...
RELIC_META_DATA = {
    "Band's Polarized Sunglasses": {
        "setKey": "Band of Sizzling Thunder",
        "slotKey": "Head",
    },
    ...
    "Belobog's Fortress of Preservation": {
        "setKey": "Belobog of the Architects",
    ...
    "Champion's Headgear": {
        "setKey": "Champion of Streetwise Boxing",
        "slotKey": "Head",
    },
    ...
    "Genius's Ultraremote Sensing Visor": {
        "setKey": "Genius of Brilliant Stars",
        "slotKey": "Head",
    },
    ...
    "Guard's Cast Iron Helmet": {
        "setKey": "Guard of Wuthering Snow",
        "slotKey": "Head",
    },
    ...
    "Knight's Forgiving Casque": {
        "setKey": "Knight of Purity Palace",
        "slotKey": "Head",
    },
    ...
    "Musketeer's Wild Wheat Felt Hat": {
        "setKey": "Musketeer of Wild Wheat",
        "slotKey": "Head",
    },
    ...
    "The IPC's Mega HQ": {
        "setKey": "Pan-Galactic Commercial Enterprise",
        "slotKey": "Planar Sphere",
    },
    ...
    "Passerby's Rejuvenated Wooden Hairstick": {
        "setKey": "Passerby of Wandering Cloud",
        "slotKey": "Head",
    },
    ...
    "Wastelander's Breathing Mask": {
        "setKey": "Wastelander of Banditry Desert",
        "slotKey": "Head",
    },
...
def get_equipped_character(equipped_avatar_img, img_path_prefix):
    ...
    for c in CHARACTER_KEYS:
        ...
        conf = cv2.matchTemplate(
            equipped_avatar_img, EQUIPPED_ICONS[c], cv2.TM_CCOEFF_NORMED
        ).max()
        if conf > max_conf:
            max_conf = conf
            character = c
